            ...
            >
              ...
              <div className="flex gap-3 mt-6 justify-center">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={initGame}
                  className="px-6 py-3 rounded-xl bg-secondary text-secondary-foreground font-body font-semibold flex items-center gap-2"
                >
                ...
                <motion.button
                  ...
                  className={`aspect-square rounded-xl text-2xl flex items-center justify-center transition-all duration-300
                    ${card.flipped || card.matched
                      ...
                      : 'valentine-gradient cursor-pointer glow-primary'
