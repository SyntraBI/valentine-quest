...
const defaultQuiz1: Question[] = [
  ...
  { question: "One Chhez Jo Apko Prnashu Mai Achi Lagti Hai ??", options: ["Everything", "Pranshu Ka Pyar", "Apka Gussa Karna", "Kuch Nhi"], correct: 1 },
...
const defaultQuiz2: Question[] = [
  ...
  { question: "Which Think Make You More Anger ???", options: ["Jab Mai Galti Karta Hu", "Mai To Bus Aise Ho Jati Hu", "Haar Cheez Per", "I hate You"], correct: 1 },
  { question: "Who wrote Romeo and Juliet?", options: ["Dickens", "Shakespeare", "Austen", "Hemingway"], correct: 1 },
  { question: "First Tym ???", options: ["Rome", "Venice", "Paris", "Barcelona"], correct: 2 },
  { question: "How Many Mintues Can You Stay Away From Me?", options: ["Full Day", "Zero", "Full Time No Limit", "10.00"], correct: 2 },
  { question: "What Is My Gher Ka Naam ???", options: ["Sunny", "Munny", "Hunny", "Bunny"], correct: 1 },
